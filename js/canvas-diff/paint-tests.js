/*
 * Canvas browser display quirks, fitted to have binary (transparent or fully-filled) pixel at (0,0), and utilities
 * for "conditional" painting using blending modes.
 *
